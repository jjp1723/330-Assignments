...
btnTaffy.onclick = () => loadTextXHR("data/taffy-facts.txt", e => {
	outputTaffy.innerHTML = e.target.responseText
});
btnViking.onclick =  () => loadTextXHR("data/viking-facts.txt", e => {
	outputViking.innerHTML = e.target.responseText
});