...
function setupCanvas(canvasElement,analyserNodeRef)
{
	...
	gradient = utils.getLinearGradient(ctx, 0, 0, 0, canvasHeight, [{percent:0,color:"black"}, {percent:.25,color:"cyan"}, {percent:.5,color:"blue"}, {percent:.75,color:"darkblue"}, {percent:1,color:"black"}]);
